          ...
          <header className="h-14 shrink-0 flex items-center justify-between px-6 border-b border-emerald-500/[0.06] bg-[#0a0f0d]/80 backdrop-blur-md">
            <span className="text-xs text-slate-600">
              {user?.role === 'SUPERADMIN' ? 'Super Admin Panel' :
               ...
               user?.role === 'DIRECTOR' ? 'Maktab Boshqaruvi' : 'Boshqaruv paneli'}
            </span>
            <div className="flex items-center gap-2">
              <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/[0.03] border border-emerald-500/[0.08] text-slate-600 text-xs hover:border-emerald-500/20 transition-colors">
