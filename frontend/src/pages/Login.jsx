    ...
    <div className="min-h-screen flex bg-[#0a0f0d] relative overflow-hidden">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center relative">
        <div className="max-w-md text-center animate-fade-in">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-400 mb-8 shadow-2xl shadow-emerald-500/25">
      ...
      <div className="w-full lg:w-[480px] flex items-center justify-center p-8 relative">
        <div className="w-full max-w-[340px] animate-slide-up">
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-400 mb-4 shadow-xl shadow-emerald-500/20">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <button type="submit" disabled={loading || !username.trim() || !password.trim()}
              className="w-full h-12 rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-teal-500 text-white text-sm font-semibold transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed active:scale-[0.98] shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/30">
              {loading ? (
