...
ExecStart=/usr/bin/java -jar target/backend-0.0.1-SNAPSHOT.jar --spring.datasource.url=jdbc:postgresql://localhost:5432/maktabdb --spring.datasource.username=postgres --spring.datasource.password=***PURGED_PASSWORD*** --spring.jpa.hibernate.ddl-auto=update --server.port=8081
Restart=always
RestartSec=5
...
Environment=DATABASE_URL=postgresql://postgres:***PURGED_PASSWORD***@localhost:5432/gilamdb
